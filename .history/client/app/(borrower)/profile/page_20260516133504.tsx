    ...
    <main className="min-h-screen bg-slate-50 py-10 px-4">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <Card className="p-6 space-y-6 border-slate-200">
          ...
          {user.role === ROLES.BORROWER && user.profile && (
            <>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-800 font-medium">
                        {user.profile.panNumber || "Not provided"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-800 font-medium capitalize">
                        {user.profile.employmentType || "Not provided"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                      ...
                      <p className="text-slate-800 font-medium">
                        {user.profile.address?.street && (
                          <>
                            ...
                            {user.profile.address.state} {user.profile.address.pincode}
                          </>
                        )}
